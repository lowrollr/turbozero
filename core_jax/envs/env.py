...
class Env:
    ...
    def reset_terminated_states(self, state: struct.PyTreeNode, terminated: jnp.ndarray) -> Tuple[struct.PyTreeNode, struct.PyTreeNode, jnp.ndarray, jnp.ndarray]:
        raise NotImplementedError()
    ...
    def get_random_legel_action(self, state: struct.PyTreeNode, observation: struct.PyTreeNode) -> jnp.ndarray:
        raise NotImplementedError()