...
def make_replay_buffer(
    ...
    if buff_type == 'end_reward':
        ...
        config = EndRewardReplayBufferConfig(buff_type=buff_type, batch_size=batch_size, **config)
        ...
        config = RankedRewardReplayBufferConfig(buff_type=buff_type, batch_size=batch_size, **config)
